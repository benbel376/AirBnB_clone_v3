...
completed version of the web application, it utilizes the following technologies: a MySQL database and Flask RESTful API with a dynamic HTML5/CSS3/jQuery front-end.
...
The project was developed in several rounds of development each in a diferent github repository identified by a version number. this is the fourth and last version.
